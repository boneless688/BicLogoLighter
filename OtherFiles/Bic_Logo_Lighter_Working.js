...
if(rep.nationality.length < 1 || nationalityUS.value == true || nationalityCanada.value == true) {
...
if (
			...
			if (doubleSidedCheckbox.value === false) {
				...
				var _path = _scriptPath.substring(
					0,
...
if (autoSave.value === true) {
	...
	//#endregion
     ...
     alert("US or Canada must be selected")
}
