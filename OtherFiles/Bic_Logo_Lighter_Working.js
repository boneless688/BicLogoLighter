...
for (i = 0; i < standardInkNumber.length; i++) {
	if (pmsNumberA2 === standardInkNumber[i]) {
		item_A1_frame.strokeWidth = 1
		item_A1_frame.strokeColor = newBlack
	}
}
...
if (ink_A2.text === "Reflex Blue" || ink_A2.text === "Process Blue") {
	item_A2_frame.strokeWidth = 1
	item_A2_frame.strokeColor = newBlack
}
...
if (pmsTest_A3 === false) {
	if (ink_A3.text === "white") {
		...
		item_A3_frame.strokeWidth = 1
		item_A3_frame.strokeColor = newBlack
...
if (pmsTest_A4 === false) {
	if (ink_A4.text === "white") {
		...
		item_A4_frame.strokeWidth = 1
		item_A4_frame.strokeColor = newBlack
	...
	if (ink_C1.text.length > 0) {
		...
		if (pmsTest_C1 === false) {
			if (ink_C1.text === "white") {
				...
				item_C1_frame.strokeWidth = 1
				item_C1_frame.strokeColor = newBlack
	...
	if (ink_C2.text.length > 0) {
		...
		if (pmsTest_C2 === false) {
			if (ink_C2.text === "white") {
				...
				item_C2_frame.strokeColor = newBlack
	...
	if (ink_C3.text.length > 0) {
		...
		if (pmsTest_C3 === false) {
			if (ink_C3.text === "white") {
				...
				item_C3_frame.strokeColor = newBlack
	...
	if (ink_C4.text.length > 0) {
		...
		if (pmsTest_C4 === false) {
			if (ink_C4.text === "white") {
				...
				item_C4_frame.strokeColor = newBlack
...
if (bodyColorList.selection === 11) {
	if (item_A1.text.length > 0) {
		item_A1_frame.strokeColor = newBlack
		item_A1_frame.fillColor = newWhite
	}

	if (item_A2.text.length > 0) {
		item_A2_frame.strokeColor = newBlack
		item_A2_frame.fillColor = newWhite
	}

	if (item_A3.text.length > 0) {
		item_A3_frame.strokeColor = newBlack
		item_A3_frame.fillColor = newWhite
	}

	if (item_A4.text.length > 0) {
		item_A4_frame.strokeColor = newBlack
		item_A4_frame.fillColor = newWhite
	}
}
...
if (
	...
	if (doubleSidedCheckbox.value == true) {
		...
		if (ink_A1.text.length < 1) {
			var lightAssortInk_Back =
				app.activeDocument.textFrames.getByName("A1_Color_Back")
